  ...
  methods: {
    ...
    addOption: function addOption() {
      if (this.selected.component === 'Radio' || this.selected.component === 'CheckBox') {
        ...
        var _obj = {};
        _obj[this.selected.config.keyLabel] = '新选项';
        _obj[this.selected.config.keyValue] = '新选项';
...
var ConfigPanel_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-tabs',{staticClass:"config-panel",attrs:{"stretch":true},model:{value:(_vm.activeName),callback:function ($$v) {_vm.activeName=$$v},expression:"activeName"}},[_c('el-tab-pane',{attrs:{"label":"字段属性","name":"field"}},[(_vm.selected.config)?_c('el-form',{ref:"configForm",attrs:{"model":_vm.selected,"rules":_vm.rules,"size":"small","label-position":"top"}},[_c('el-form-item',{attrs:{"label":"控件名称"}},[_c('el-input',{attrs:{"autocomplete":"off","placeholder":"请输入控件名称"},model:{value:(_vm.selected.formItemConfig.base.label),callback:function ($$v) {_vm.$set(_vm.selected.formItemConfig.base, "label", $$v)},expression:"selected.formItemConfig.base.label"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"字段name值"}},[_c('el-input',{attrs:{"autocomplete":"off","placeholder":""},model:{value:(_vm.selected.config.name),callback:function ($$v) {_vm.$set(_vm.selected.config, "name", $$v)},expression:"selected.config.name"}})],1),_vm._v(" "),(_vm.selected.config.hasOwnProperty('placeholder'))?_c('el-form-item',{attrs:{"label":"占位提示"}},[_c('el-input',{attrs:{"autocomplete":"off","placeholder":"显示在框内的提示文字"},model:{value:(_vm.selected.config.placeholder),callback:function ($$v) {_vm.$set(_vm.selected.config, "placeholder", $$v)},expression:"selected.config.placeholder"}})],1):_vm._e(),_vm._v(" "),_c('el-form-item',{attrs:{"label":"文字提示"}},[_c('el-input',{attrs:{"autocomplete":"off","placeholder":"显示在表单项下方的提示文字","type":"textarea"},model:{value:(_vm.selected.config.textTip),callback:function ($$v) {_vm.$set(_vm.selected.config, "textTip", $$v)},expression:"selected.config.textTip"}})],1),_vm._v(" "),(_vm.showOptions)?_c('div',{staticClass:"line"}):_vm._e(),_vm._v(" "),(_vm.showOptions)?_c('el-form-item',{attrs:{"label":"选项"}},[_c('el-radio-group',{attrs:{"size":"mini"},model:{value:(_vm.selected.config.bind),callback:function ($$v) {_vm.$set(_vm.selected.config, "bind", $$v)},expression:"selected.config.bind"}},[(_vm.selected.component!=='Tree'&&_vm.selected.component!=='Transfer')?_c('el-radio-button',{attrs:{"label":false}},[_vm._v("静态数据")]):_vm._e(),_vm._v(" "),_c('el-radio-button',{attrs:{"label":true}},[_vm._v("绑定数据")])],1),_vm._v(" "),(_vm.selected.config.bind)?_c('div',{staticClass:"bind-tab"},[_c('el-select',{attrs:{"placeholder":"选择数据key","clearable":""},model:{value:(_vm.selected.config.keyBindData),callback:function ($$v) {_vm.$set(_vm.selected.config, "keyBindData", $$v)},expression:"selected.config.keyBindData"}},_vm._l((Object.keys(_vm.bindData[_vm.selected.component]||{})),function(item,index){return _c('el-option',{key:index,attrs:{"label":item,"value":item}})}),1)],1):_c('div',{staticClass:"bind-tab static-data"},[_vm._l((_vm.selected.config.options),function(option,index){return _c('el-form-item',{key:index},[_c('div',[_c('el-input',{model:{value:(option[_vm.selected.config.keyLabel]),callback:function ($$v) {_vm.$set(option, _vm.selected.config.keyLabel, $$v)},expression:"option[selected.config.keyLabel]"}},[_c('template',{slot:"prepend"},[_vm._v("标签")])],2),_vm._v(" "),(_vm.selected.component==='Select'||_vm.selected.component==='MultiSelect')?_c('el-input',{model:{value:(option[_vm.selected.config.keyValue]),callback:function ($$v) {_vm.$set(option, _vm.selected.config.keyValue, $$v)},expression:"option[selected.config.keyValue]"}},[_c('template',{slot:"prepend"},[_vm._v("值")])],2):_vm._e()],1),_vm._v(" "),_c('div',[_c('el-button',{attrs:{"type":"danger","circle":"","plain":"","size":"mini"},on:{"click":function($event){$event.preventDefault();_vm.removeOption(index)}}},[_c('svg-icon',{attrs:{"iconClass":"vel-fb-minus"}})],1)],1)])}),_vm._v(" "),_c('el-button',{attrs:{"type":"text"},on:{"click":function($event){$event.preventDefault();_vm.addOption()}}},[_vm._v("添加选项")])],2),_vm._v(" "),_c('el-form-item',{attrs:{"prop":"config.keyLabel"}},[_c('el-input',{model:{value:(_vm.selected.config.keyLabel),callback:function ($$v) {_vm.$set(_vm.selected.config, "keyLabel", $$v)},expression:"selected.config.keyLabel"}},[_c('template',{slot:"prepend"},[_vm._v("标签key")])],2)],1),_vm._v(" "),(_vm.selected.component==='Select'||_vm.selected.component==='MultiSelect')?_c('el-form-item',{attrs:{"prop":"config.keyValue"}},[_c('el-input',{model:{value:(_vm.selected.config.keyValue),callback:function ($$v) {_vm.$set(_vm.selected.config, "keyValue", $$v)},expression:"selected.config.keyValue"}},[_c('template',{slot:"prepend"},[_vm._v("值key")])],2)],1):_vm._e(),_vm._v(" "),(_vm.selected.component==='Tree'||_vm.selected.component==='Transfer')?_c('el-form-item',{attrs:{"prop":"config.keyChildren"}},[_c('el-input',{model:{value:(_vm.selected.config.keyChildren),callback:function ($$v) {_vm.$set(_vm.selected.config, "keyChildren", $$v)},expression:"selected.config.keyChildren"}},[_c('template',{slot:"prepend"},[_vm._v("子节点key")])],2)],1):_vm._e(),_vm._v(" "),(_vm.selected.component==='Tree'||_vm.selected.component==='Transfer')?_c('el-form-item',{attrs:{"prop":"config.nodeKey"}},[_c('el-input',{model:{value:(_vm.selected.config.nodeKey),callback:function ($$v) {_vm.$set(_vm.selected.config, "nodeKey", $$v)},expression:"selected.config.nodeKey"}},[_c('template',{slot:"prepend"},[_vm._v("节点key")])],2)],1):_vm._e()],1):_vm._e(),_vm._v(" "),_c('div',{staticClass:"line"}),_vm._v(" "),_c('el-form-item',{staticClass:"rules",attrs:{"label":"校验规则"}},[_c('el-form-item',[_c('el-checkbox',{attrs:{"label":"必填","name":"required"},model:{value:(_vm.selected.formItemConfig.extra.configRules.required),callback:function ($$v) {_vm.$set(_vm.selected.formItemConfig.extra.configRules, "required", $$v)},expression:"selected.formItemConfig.extra.configRules.required"}})],1),_vm._v(" "),(_vm.selected.formItemConfig.extra.configRules.hasOwnProperty('min'))?_c('el-form-item',[_c('el-col',{attrs:{"span":11}},[_c('el-form-item',{attrs:{"prop":"formItemConfig.extra.configRules.min"}},[_c('el-input',{attrs:{"type":"age","autocomplete":"off","placeholder":"最小长度"},model:{value:(_vm.selected.formItemConfig.extra.configRules.min),callback:function ($$v) {_vm.$set(_vm.selected.formItemConfig.extra.configRules, "min", _vm._n($$v))},expression:"selected.formItemConfig.extra.configRules.min"}})],1)],1),_vm._v(" "),_c('el-col',{staticStyle:{"text-align":"center"},attrs:{"span":2}},[_vm._v("-")]),_vm._v(" "),_c('el-col',{attrs:{"span":11}},[_c('el-form-item',{attrs:{"prop":"formItemConfig.extra.configRules.max"}},[_c('el-input',{attrs:{"type":"age","autocomplete":"off","placeholder":"最大长度"},model:{value:(_vm.selected.formItemConfig.extra.configRules.max),callback:function ($$v) {_vm.$set(_vm.selected.formItemConfig.extra.configRules, "max", _vm._n($$v))},expression:"selected.formItemConfig.extra.configRules.max"}})],1)],1)],1):_vm._e(),_vm._v(" "),(_vm.selected.formItemConfig.extra.configRules.hasOwnProperty('reg'))?_c('el-form-item',{attrs:{"prop":"formItemConfig.extra.configRules.reg"}},[_c('el-input',{attrs:{"autocomplete":"off","placeholder":"正则表达式"},model:{value:(_vm.selected.formItemConfig.extra.configRules.reg),callback:function ($$v) {_vm.$set(_vm.selected.formItemConfig.extra.configRules, "reg", $$v)},expression:"selected.formItemConfig.extra.configRules.reg"}})],1):_vm._e()],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"校验失败提示"}},[_c('el-input',{attrs:{"autocomplete":"off"},model:{value:(_vm.selected.formItemConfig.extra.failedMessage),callback:function ($$v) {_vm.$set(_vm.selected.formItemConfig.extra, "failedMessage", $$v)},expression:"selected.formItemConfig.extra.failedMessage"}})],1),_vm._v(" "),(_vm.selected.component==='Upload')?_c('div',{staticClass:"line"}):_vm._e(),_vm._v(" "),(_vm.selected.component==='Upload')?_c('div',[_c('el-form-item',{attrs:{"label":"上传地址"}},[_c('el-input',{attrs:{"autocomplete":"off"},model:{value:(_vm.selected.config.action),callback:function ($$v) {_vm.$set(_vm.selected.config, "action", $$v)},expression:"selected.config.action"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"文件类型"}},[_c('el-input',{attrs:{"autocomplete":"off","placeholder":"如application/pdf,image/png"},model:{value:(_vm.selected.config.accept),callback:function ($$v) {_vm.$set(_vm.selected.config, "accept", $$v)},expression:"selected.config.accept"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"数量限制"}},[_c('el-input',{attrs:{"autocomplete":"off"},model:{value:(_vm.selected.config.limit),callback:function ($$v) {_vm.$set(_vm.selected.config, "limit", _vm._n($$v))},expression:"selected.config.limit"}})],1)],1):_vm._e()],1):_vm._e()],1),_vm._v(" "),_c('el-tab-pane',{attrs:{"label":"表单属性","name":"form"}},[_c('el-form',{ref:"formConfigForm",attrs:{"model":_vm.formConfig,"size":"small","label-position":"top"}},[_c('el-form-item',{attrs:{"label":"标签宽度"}},[_c('el-input-number',{attrs:{"step":10,"min":0,"max":200,"controls-position":"right"},model:{value:(_vm.formConfig.base['label-width']),callback:function ($$v) {_vm.$set(_vm.formConfig.base, 'label-width', $$v)},expression:"formConfig.base['label-width']"}})],1),_vm._v(" "),_c('el-form-item',{attrs:{"label":"列数"}},[_c('el-radio-group',{model:{value:(_vm.formConfig.extra.cols),callback:function ($$v) {_vm.$set(_vm.formConfig.extra, "cols", $$v)},expression:"formConfig.extra.cols"}},[_c('el-radio',{attrs:{"label":1}},[_vm._v("1")]),_vm._v(" "),_c('el-radio',{attrs:{"label":2}},[_vm._v("2")]),_vm._v(" "),_c('el-radio',{attrs:{"label":3}},[_vm._v("3")])],1)],1)],1)],1)],1)}
